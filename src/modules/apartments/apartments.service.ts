...
export class ApartmentsService {
  ...
  async submitPartnerCooperation(
    ...
    if (partner?.createdByStaffId) {
      await this.notifySafely({
        ...
        title: 'Đối tác gửi căn hộ hợp tác mới',
        message: `Đối tác vừa gửi căn hộ ${apartment.apartmentNumber} cho quy trình hợp tác.`,
  ...
  async rejectPartnerCooperation(
    ...
    if (apartment.ownerId) {
      await this.notifySafely({
        ...
        message: `Căn hộ ${apartment.apartmentNumber} đã bị điều phối viên từ chối. Lý do: ${reason}`,
  ...
  async approvePartnerCooperation(id: string, operatorId: string) {
    ...
    await this.notifySafely({
      ...
      message: `Căn hộ ${result.approvedApartment.apartmentNumber} đã được điều phối viên duyệt và tạo hợp đồng hợp tác.`,
  ...
  async partnerSignCooperationContract(
    ...
    if (contract.approvedByOperatorId) {
      await this.notifySafely({
        ...
        title: 'Đối tác đã ký hợp đồng hợp tác',
        message: `Đối tác đã ký và tải lên hợp đồng cho căn hộ ${apartment.apartmentNumber}.`,
  ...
  async cancelPartnerCooperationContract(
    ...
    if (contract.approvedByOperatorId) {
      await this.notifySafely({
        recipientType: ActorType.operator,
        recipientId: contract.approvedByOperatorId,
        title: 'Đối tác đã hủy hợp đồng hợp tác',
        message: `Đối tác đã hủy hợp đồng hợp tác của căn hộ ${apartment.apartmentNumber}.`,
        actionUrl: `/apartments/${apartmentId}/cooperation-contract`,
        actionLabel: 'Xem hợp đồng',
        relatedEntityType: 'Apartment',
        relatedEntityId: apartmentId,
